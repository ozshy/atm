...
#
setwd("~/Papers/atm/atm_coding") # Set working directory on your computer
# Your working directory would be different from the above!
#
dir()
#### Using the larger dataset 
trans1=readRDS("atm_merged_2017_2018_190808.rds")# Read cw data file (all transactions)
names(trans1)
nrow(trans1)
trans1_17 = subset(trans1, year == 2017)
trans1_18 = subset(trans1, year == 2018)
(trans_respondents_17 = nrow(trans1_17[unique(trans1_17$uasid) , ]))
(trans_respondents_18 = nrow(trans1_18[unique(trans1_18$uasid) , ]))
...
length(unique(trans3$uasid))# num of respondents (in-person only)
...
length(unique(trans5$uasid))# num respondents
#
...
table(trans6$pi)
dim(trans6)
length(unique(trans6$uasid)) # num of respondents
nrow(trans6) - nrow(trans5)# num payments lost by restricting PI
length(unique(trans6$uasid)) - length(unique(trans5$uasid)) # num respondents lost by restricting PI
...
(cw_respondents_17 = nrow(cw3_17[unique(cw3_17$uasid) , ])) # Number of respondents who withdrew cash in 2017
...
length(table(cw3_17$uasid)[table(cw3_17$uasid) == 1]) 
length(table(cw3_17$uasid)[table(cw3_17$uasid) == 2]) 
length(table(cw3_17$uasid)[table(cw3_17$uasid) == 3]) # 3 ATM withdrawals
length(table(cw3_17$uasid)[table(cw3_17$uasid) > 3]) # more than 3 ATM withdrawals
#
# the above for 2018
(cw_number_18 = nrow(cw3_18)) # Number of CW over 3 diary days
(cw_respondents_18 = nrow(cw3_18[unique(cw3_18$uasid) , ])) # Number of respondents who withdrew cash in 2018
...
# Stats about respondent who actually withdrew cash during the 3 day survey period
# Below, number of respondents who withdrew twice in 3 days
length(table(cw3_18$uasid)[table(cw3_18$uasid) == 1]) 
length(table(cw3_18$uasid)[table(cw3_18$uasid) == 2]) 
length(table(cw3_18$uasid)[table(cw3_18$uasid) == 3]) # 3 ATM withdrawals
length(table(cw3_18$uasid)[table(cw3_18$uasid) > 3]) # more than 3 ATM withdrawals
...
length(unique(subset(trans6, amnt <= 45)$uasid))# num of resp
...
length(unique(atm_50s$uasid)) # Num resp in Figure 4
# end of Figure 3
...
length(unique(trans8$uasid)) # num of respondents
...
length(unique(trans9$uasid)) # num of respondents
